...
$code=$_REQUEST[code];
	...
	$record=mysql_query("SELECT * FROM $selclass WHERE (code='{$code}')");
...
<table border="1"  cellspacing=0 cellpadding=0>
	<tr align="center">
		...
		<td width=700>
			<h3><?php print($table[subject]); ?></h3>
			<h5><?php print($table[teacher]); ?></h5>
			...
			<font size="2">
			<b>教科書：</b><br><br>
			　<a href="http://opac.iic.kochi-u.ac.jp/webopac/catsre.do" target="_blank" alt="高知大学図書館" title="高知大学図書館">OPACで検索</a>
			　　|　<a href="http://www.amazon.co.jp">Amazonで検索</a><br><br>
			<b>試験：</b><br><br>
			<b>出席：</b><br><br>
			</font>
			</div>
